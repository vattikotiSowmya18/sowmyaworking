...
"""
    ...
    def process_all_steps(self):
        ...
        #print("Step 16 labeling enabled:", self.params['step_16_labeling']['enabled'])

        # Step 16: Label Connected Components  (was Step 10)
        ...
        self.step_images[16] = cv2.cvtColor(labeled_colored, cv2.COLOR_BGR2RGB)
        self.step_data['labeled'] = labeled_cleaned
        self.step_data['num_labels'] = num_cleaned

 step17_input = step16_input.copy()
        # Step 17: Final Result with Colored Segments  (was Step 11)
        """
        result = self.tab2_cv_image.copy()
        min_area = self.params['step_17_final']['min_area']
        max_area = self.params['step_17_final']['max_area']
        ...
        self.step_images[17] = cv2.cvtColor(result, cv2.COLOR_BGR2RGB)
        """
        step17_input = step16_input.copy()
